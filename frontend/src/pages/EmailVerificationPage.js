...
const EmailVerificationPage = () => {
    ...
    const handleChange = (index, value) => {
        ...
        if(value.length > 1){
            ...
            // Focus on the last non-empty input or the first emplty one
            ...
            // Move focus to the next input field if value is entred
            if(value && index < 5){
    ...
    const handleSubmit = async (e) => {
        ...
        //     navigate("/");
        //     toast.success("Email verified successfullly");
        // } catch (error) {
        //     console.log(error);
        // }
    };
            ...
            >
                ...
                <form onSubmit={handleSubmit} className='space-y-6'>
                    ...
                    <motion.button
                        ...
                        className='w-full bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold py-3 px-4 rounded-lg shadow-lg hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-opacity-50 disabled:opacitiy-50'
                    >
